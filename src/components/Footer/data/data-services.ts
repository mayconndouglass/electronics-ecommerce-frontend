export const dataServices = [
  {
    id: 1,
    img: '../assets/images/footer-service1.avif',
    title: 'Entrega rápida e segura',
    subTitle: 'Conte com o nosso serviço.'
  },
  {
    id: 2,
    img: '../assets/images/footer-service2.avif',
    title: 'Devolução de dinheiro',
    subTitle: 'No prazo de 10 dias.'
  },
  {
    id: 3,
    img: '../assets/images/footer-service3.avif',
    title: 'Devolução em 24 horas',
    subTitle: 'Não pergunte.'
  },
  {
    id: 4,
    img: '../assets/images/footer-service4.avif',
